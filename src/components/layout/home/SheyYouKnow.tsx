...
const SheyYouKnow = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center h-full my-auto py-10 md:py-20 px-3 md:px-20 lg:px-24">
      ...
      <div className="py-10 space-y-6 text-left">
        ...
        <Button
          size="lg"
          className="bg-primary hover:bg-primary/90 transition text-white font-bold w-fit cursor-pointer shadow-md"
        >
          Sharp! 👉
        </Button>
      </div>
